...
Была спланирована адресация андерлей сети из расчёта максимального количества VTEP для cisco в количестве 1000 шт, два адреса на стык со спайном по /31 сети, итого /21 Блок на стыки, /22 для loopback'ов.
...
Не доделано: 
- настроить BGW002;
- подключить и настроить линк между BGW внутри ЦОД??
- настроить Роутеры, фаерволы (в части BGP и NAT для выхода в интернет);
- настроить сегмент "старой сети" на DC02-OSW001
Планирую сделать после решения проблемы с L3 трафиком
...
<details>
  <summary>📸 Нажмите, чтобы развернуть скриншот</summary>

  ![Дамп сети](./images/dump001.png)
