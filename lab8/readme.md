...
R003 перезаписывает ASN соседа в фабрике, если маршрут пришёл от LSW007 vrf TEST и его надо направить в vrf PROD, то LSW007 такой маршрут дропнет без перезаписи.
