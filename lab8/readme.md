...
3. [Дополнительное задание 1](#дополнительное-задание-1)
4. [Дополнительное задание 2](#дополнительное-задание-2)
...
R003 перезаписывает в AS-PATH ASN соседа в фабрике, если маршрут пришёл от LSW007 vrf TEST и его надо направить в vrf PROD, то LSW007 такой маршрут дропнет без перезаписи.

Выключаем LSW007. Смотрим, что получилось (после отработки BGP).
